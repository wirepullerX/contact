  ...
  <div class="container">
    <form>
      ...
      <div class="btn-group" role="group" aria-label="Basic outlined example">
        ...
        <button type="submit" class="btn btn-outline-primary" @click="addToAPI"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span>Save</button>
      <router-link to="/">  
  ...
  methods: {
      addToAPI () {
        if(this.User.firstName=='' || this.User.lastName=='' || this.User.contactID=='' || this.User.mobileNo==''){
          ...
          axios.post('https://git.heroku.com/sheltered-plateau-34648.git/contacts/add', newUser)
          .then((response)=>{
